...
define("API_URL","http://api.hfdatas.com/superapi/super/auth/smrz4");
define("USER_CODE","MDWL201702171648030000");
define("DES_KEY","tQT3KvdRbm1bv6Esp9NzjwiG");
define("SYS_CODE","MDWLAPP201702211605160000");
define("DES_IV",date("dHis"));
class FourElementAuth{
	/**
	 * 验证

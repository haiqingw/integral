...
(function($){
	...
	$.fn.datepicker = function(opts){
		var setting = {
			...
			clearBut$:"#calendar .clearBut", todayBut$:"#calendar .todayBut", okBut$:"#calendar .okBut"
		};
		...
		return this.each(function(){
			...
			$this.click(function(event){
                ...
                $(setting.todayBut$).click(function(){
                    ...
                    var _today=todayDate.getDate();
                    if(parseInt(_month)<10){
                        _month='0'+_month;
                    }
                    if(parseInt(_today)<10){
                        _today='0'+_today;
                    }
					$this.val(todayDate.getFullYear()+'-'+_month+'-'+_today);
					closeCalendar();
				});

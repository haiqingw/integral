			...
			function displayItems(items) {
				...
				if (items=='') {//热门城市遍历
					for(h in options.hot_list){
						//console.log(options.attachObject);
						if(options.attachObject == "#suggests_seller"){
							var ck = "";
						}else if(options.attachObject == "#suggests"){
							var ck = 'onclick="seller_select('+options.hot_list[h][0]+')"';
						}
						html+='<li '+ck+' rel="'+options.hot_list[h][0]+'"><a href="#'+h+'"><span>'+options.hot_list[h][2]+'</span>'+options.hot_list[h][1]+'</a></li>';
					}

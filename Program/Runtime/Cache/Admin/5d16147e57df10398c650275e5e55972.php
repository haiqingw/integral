    ...
    <div class="tabs">
        ...
        <div class="tabsContent">
            ...
            <div>
                        ...
                        <li>
                            ...
                            <ul>
                                <?php if(is_array($resArray)): $i = 0; $__LIST__ = $resArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                        ...
                                        <ul>
                                            <?php if(is_array($v['data'])): $i = 0; $__LIST__ = $v['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('ChangeFunds/cords');?>?plat=<?php echo ($v["plat"]); ?>&types=<?php echo ($val["englishname"]); ?>"
                                                        target="ajax" rel="jbsxBoxBUSYSCAGEFUNDESLIST"><?php echo ($val["classname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                            <li><a href="<?php echo U('ChangeFunds/cords');?>?plat=<?php echo ($v["plat"]); ?>&types=SD" target="ajax"
                                                    rel="jbsxBoxBUSYSCAGEFUNDESLIST">退扣款</a></li>
                                            <li><a href="<?php echo U('ChangeFunds/cords');?>?plat=<?php echo ($v["plat"]); ?>&types=TX" target="ajax"
                                                    rel="jbsxBoxBUSYSCAGEFUNDESLIST">收益提现</a></li>
                                        </ul>
                ...
                <div id="jbsxBoxBUSYSCAGEFUNDESLIST" class="unitBox" style="margin-left: 346px;">

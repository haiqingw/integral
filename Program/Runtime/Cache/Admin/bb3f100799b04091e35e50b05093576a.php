...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="edit" href="<?php echo U('addCategory');?>?cid={cid}" target="navTab" rel="addCategory" width="320" height='180'><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="75">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr target="cid" rel="<?php echo ($v["id"]); ?>">
				...
				<td align="center">
					<?php if($v["status"] == 1): ?><a href="<?php echo U('stopCategory');?>?cid=<?php echo ($v["id"]); ?>" target="ajaxTodo" title="停用后公司无法添加模板！确定要停用？"><font color=#FF0000>停用</font></a><?php endif; ?>
					<?php if($v["status"] == 2): ?><a href="<?php echo U('openCategory');?>?cid=<?php echo ($v["id"]); ?>" target="ajaxTodo" title="是否开启该分类？"><font color=#0099FF>开启</font></a><?php endif; ?>
				</td>
	...
	<div class="panelBar">
        ...
        <div class="pagination" targetType="navTab" totalCount="<?php echo ($totalCount); ?>" numPerPage="<?php echo ($limit); ?>" pageNumShown="10" currentPage="<?php echo ($page); ?>"></div>
	</div>
</div>
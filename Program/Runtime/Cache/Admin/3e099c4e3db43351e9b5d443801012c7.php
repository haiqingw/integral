<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent" style="padding: 5px">
    <div class="panel" defH="60">
        <h1>查找平台用户</h1>
        <div>
            <form id="form" action="<?php echo U('Platdrawmanage/index');?>" onsubmit="return navTabSearch(this);" method="post">
    ...
    <div class="tabs">
        <div class="tabsHeader">
            <div class="tabsHeaderContent">
                <ul>
                    <li><a href="javascript:;"><span>订单提现审核</span></a></li>
                </ul>
            </div>
        </div>
        <div class="tabsContent">
            ...
            <div>
                        ...
                        <li>
                            ...
                            <ul>
                                <?php if(is_array($resArray)): $i = 0; $__LIST__ = $resArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                        <a href="<?php echo U('Platdrawmanage/drawlist');?>?plat=<?php echo ($v["plat"]); ?>" target="ajax" rel="jbsxBoxORDRAWREI"><?php echo ($v["company"]); ?>
                                            ...
                                            <span style="background:#696969;color:#fff;padding:0 8px; border-radius:15px; font-size:12px;float:right;display:inline-block; line-height:16px;margin:4px 10px 0 0;height:15px;overflow: hidden;">待审核：<?php echo ($v["drawcon"]); ?>&nbsp;条</span>
                                        </a>
                ...
                <div id="jbsxBoxORDRAWREI" class="unitBox" style="margin-left: 346px;">

    ...
    <div class="tabs">
        ...
        <div class="tabsContent">
            ...
            <div>
                        ...
                        <li>
                            ...
                            <ul>
                                <?php if(is_array($resArray)): $i = 0; $__LIST__ = $resArray;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                        <a href="<?php echo ($url); ?>?plat=<?php echo ($v["plat"]); ?>&keys=<?php echo ($keys); ?>" target="ajax" rel="jbsxBoxDRAWLISTS<?php echo ($keys); ?>"><?php echo ($v["company"]); ?>
                ...
                <div id="jbsxBoxDRAWLISTS<?php echo ($keys); ?>" class="unitBox" style="margin-left: 346px;">

        ...
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <td>
                        开始时间：<input type="text" name="datestart" class="date" readonly="true" value="<?php echo ($datestart); ?>"/>
                        <a class="inputDateButton" href="javascript:;">选择</a>
                    </td>
                    <td>
                        结束时间：<input type="text" name="dateend" class="date" readonly="true"  value="<?php echo ($dateend); ?>"/>
                        <a class="inputDateButton" href="javascript:;">选择</a>
                    </td>
                    <td align="left">
